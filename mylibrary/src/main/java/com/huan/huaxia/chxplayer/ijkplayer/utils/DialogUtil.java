package com.huan.huaxia.chxplayer.ijkplayer.utils;
...
public class DialogUtil {
    //new dialog
    public static void showUnSubscribeDialog(final Context mContext, boolean isTV) {
        ...
        if (null != dialog.getWindow()) {
            ...
            if (isTV)
                ...
                dialog.getWindow().setLayout(display.getWidth() / 2, display.getHeight() / 3);
            dialog.show();
        }
    }
