package com.summer.chxplayer.widght.utils.anim;
...
public class LoveLikeLayout extends RelativeLayout {
    ...
    private Animator getAnimator(View target) {
        AnimatorSet enterAnimatorSet = getEnterAnimtorSet(target);
        ValueAnimator bezierAnimator = getBezierAnimtor(target);
        AnimatorSet animatorSet = new AnimatorSet();
        animatorSet.playSequentially(enterAnimatorSet);
        animatorSet.playSequentially(enterAnimatorSet, bezierAnimator);
